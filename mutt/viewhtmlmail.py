...
# ---------
#
# Not author's note: This file is a mess, and I don't vouch for it, but
# it does seem to work. I had to rewrite some of it to *get it to work*
# but whatever.
#
# <3 Tyler
...
def view_html_message(mbox, tmpdir):
    ...
    for p, c, f in os.walk(mbox):
        if f:
            mbox = os.path.join(p, f[0])
    ...
    print "Calling xdg-open file://" + htmlfile
    os.system("xdg-open file://" + htmlfile)

    # This is the dumbest program ever - thc
    time.sleep(5)
